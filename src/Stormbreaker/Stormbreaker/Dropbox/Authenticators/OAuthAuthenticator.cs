...
namespace Stormbreaker.Dropbox.Authenticators
{
    public class OAuthAuthenticator : IAuthenticator {
        ...
        // Methods
        public OAuthAuthenticator(string baseUrl, string consumerKey, string consumerSecret) : this(baseUrl, consumerKey, consumerSecret, string.Empty, string.Empty) { }
