...
namespace BrickPile.Core.Mvc
{
    public class ControllerMapper : IControllerMapper
    {
        ...
        {
            return ControllerActionMap.ContainsKey(controllerName) && ControllerActionMap[controllerName].Any(action => String.Equals(action, actionName, StringComparison.InvariantCultureIgnoreCase));
        }
