...
namespace BrickPile.FileSystem.AmazonS3 {
    /// <summary>
    /// 
    /// </summary>
    public class MimeMapping {
        ...
        /// </summary>
        static MimeMapping() {
            MimeMapping._extensionToMimeMappingTable = new Hashtable(190);
            ...
            MimeMapping.AddMimeMapping(".json", "text/plain");
